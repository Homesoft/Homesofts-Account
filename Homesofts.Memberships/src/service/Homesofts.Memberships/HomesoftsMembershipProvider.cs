...
namespace Homesofts.Memberships
{
    public sealed class MongoDBMembershipProvider : MembershipProvider
    {
        ...
        public override bool DeleteUser(string username, bool deleteAllRelatedData)
        {
            ...
            User user = getProviderUser(username, true);
            UsersCollection.Remove(Query.EQ("Email", user.Email), WriteConcern.Acknowledged);
            UserRolesCollection.Remove(Query.EQ("UserId", user.Id), WriteConcern.Acknowledged);
            return true;
        }
