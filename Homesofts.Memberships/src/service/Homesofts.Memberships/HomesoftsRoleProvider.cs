...
using Homesofts.Memberships.Models;
...
namespace Homesofts.Memberships
{
    public sealed class HomesoftsRoleProvider : RoleProvider
    {
        ...
        public override void AddUsersToRoles(string[] usernames, string[] rolenames)
        {
            ...
            foreach (var user in users)
            {
                ...
                {
                    UserRolesCollection.Save(role.AddUser(user), WriteConcern.Acknowledged);
                }
            }
        }
        ...
        public override void CreateRole(string rolename)
        {
            ...
            RolesCollection.Save(role, WriteConcern.Acknowledged);
        }
        ...
        public override void RemoveUsersFromRoles(string[] usernames, string[] rolenames)
        {
            ...
            if (deleteUserRolesIds.IsNotEmpty())
                UserRolesCollection.Remove(Query.In("_id", deleteUserRolesIds), WriteConcern.Acknowledged);
        }
